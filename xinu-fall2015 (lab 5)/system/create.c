	...
	)
{
	...
	prptr->isAsynchronous = FALSE;
	prptr->hasCBFunction = FALSE;
	prptr->cbPointer = NULL;
	prptr->alrmPointer = NULL;
	prptr->xcpuPointer = NULL;
	prptr->isALRMReady = FALSE;
	prptr->memoryBlocks.mlength = NULL;
	prptr->memoryBlocks.mnext = NULL;
