...
extern pid32 myenqueue(pid32, qid16);

extern pid32 mydequeue(qid16);
...
extern	syscall	registercb(int(*func)(void));

extern  syscall registercbsig(uint16, int(* func)(void), uint32);

extern qid16 alrmmynewqueue(void);

extern pid32 alrmmyenqueue(pid32, qid16);

extern pid32 alrmmydequeue(qid16);

extern pid32 alrmmygetfirst(qid16);

extern pid32 alrmmygetlast(qid16);

extern pid32 alrmmygetitem(pid32);

extern status alrminsertd(pid32, qid16, int32);

extern void alrmmywakeup(void);