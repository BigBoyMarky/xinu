...
struct procent {		/* Entry in the process table		*/
	...
	void    *alrmPointer; // pointer to the alrm callback function
	uint32  alrmTime; // the time of the alarm
	void    *xcpuPointer; // pointer to the cpu callback function
	uint32  xcpuTime; // the time of the cpu
	bool8   isALRMReady; // to check if the alrmTime is up or not
	struct memblk memoryBlocks; // list to hold all of the blocks of memory that the process is using
